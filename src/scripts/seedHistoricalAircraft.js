...
,
  ...
  // ========================================
  // COMBI AIRCRAFT - mixed main-deck passenger + freight
  // (airframe type + isCombi flag; see Bristol 170 Combi)
  // ========================================
  ...
  // ========================================
  // AIRSHIPS - sightseeing, tourism, light lift
  // ========================================
...
async function seedHistoricalAircraft() {
  try {
    ...
    // Ensure the aircraft type enum allows 'Airship' before importing airships
    // (harmless if the server already added it on boot).
    try {
      await sequelize.query(`ALTER TYPE enum_aircraft_type ADD VALUE IF NOT EXISTS 'Airship'`);
    } catch (_) { /* enum may not exist yet on a fresh DB — sync will create it */ }
