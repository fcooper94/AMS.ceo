...
class ZoneAssignmentService {
  ...
  countryNameToCode(countryName) {
    const mapping = {
      ...
      // Island nations, territories, and smaller countries
      'Solomon Islands': 'SB', 'Nauru': 'NR', 'Greenland': 'GL', 'Kosovo': 'XK',
      'Benin': 'BJ', 'Burkina Faso': 'BF', 'Niger': 'NE', 'Togo': 'TG',
      'Isle of Man': 'IM', 'Falkland Islands': 'FK', 'Faroe Islands': 'FO',
      'Republic of the Congo': 'CG', 'Congo (Brazzaville)': 'CG',
      'Central African Republic': 'CF', 'Comoros': 'KM', 'Mayotte': 'YT',
      'Réunion': 'RE', 'São Tomé and Principe': 'ST', 'Seychelles': 'SC',
      'Chad': 'TD', 'Lesotho': 'LS', 'Eswatini': 'SZ', 'Swaziland': 'SZ',
      'Gambia': 'GM', 'Sierra Leone': 'SL', 'Guinea-Bissau': 'GW',
      'Liberia': 'LR', 'Guinea': 'GN', 'Equatorial Guinea': 'GQ',
      'Gabon': 'GA', 'Zambia': 'ZM', 'Malawi': 'MW', 'Namibia': 'NA',
      'Mali': 'ML', 'Mauritania': 'MR', 'Burundi': 'BI', 'Djibouti': 'DJ',
      'Rwanda': 'RW', 'Somalia': 'SO', 'Eritrea': 'ER', 'South Sudan': 'SS',
      'Western Sahara (disputed territory)': 'EH',
      'Saint Pierre and Miquelon': 'PM', 'Gibraltar': 'GI',
      'Turks and Caicos Islands': 'TC', 'Cayman Islands': 'KY', 'Belize': 'BZ',
      'Cook Islands': 'CK', 'Tuvalu': 'TV', 'Wallis and Futuna': 'WF',
      'Samoa': 'WS', 'American Samoa': 'AS', 'French Polynesia': 'PF',
      'Vanuatu': 'VU', 'New Caledonia': 'NC', 'Guam': 'GU',
      'Northern Mariana Islands': 'MP', 'Marshall Islands': 'MH',
      'Micronesia': 'FM', 'Palau': 'PW', 'Tonga': 'TO', 'Kiribati': 'KI',
      'Suriname': 'SR', 'French Guiana': 'GF', 'Guyana': 'GY',
      'Antigua and Barbuda': 'AG', 'Dominica': 'DM', 'Martinique': 'MQ',
      'Guadeloupe': 'GP', 'Grenada': 'GD', 'Saint Kitts and Nevis': 'KN',
      'Saint Lucia': 'LC', 'Aruba': 'AW', 'Caribbean Netherlands': 'BQ',
      'Curaçao': 'CW', 'Sint Maarten': 'SX', 'Anguilla': 'AI',
      'Montserrat': 'MS', 'British Virgin Islands': 'VG', 'Bermuda': 'BM',
      'Saint Vincent and the Grenadines': 'VC', 'U.S. Virgin Islands': 'VI',
      'Kyrgyzstan': 'KG', 'Turkmenistan': 'TM', 'Tajikistan': 'TJ',
      'Mongolia': 'MN', 'North Korea': 'KP', 'Bhutan': 'BT',
      'Afghanistan': 'AF', 'Syria': 'SY', 'Yemen': 'YE', 'Maldives': 'MV',
      'Timor-Leste': 'TL', 'East Timor': 'TL',
      'Cocos (Keeling) Islands': 'CC', 'Christmas Island': 'CX'
    };
