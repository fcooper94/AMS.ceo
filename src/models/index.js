...
// RecurringMaintenance associations
UserAircraft.hasMany(RecurringMaintenance, { foreignKey: 'aircraft_id', as: 'recurringMaintenance' });
RecurringMaintenance.belongsTo(UserAircraft, { foreignKey: 'aircraft_id', as: 'aircraft' });
...
// WeeklyFinancial associations
WorldMembership.hasMany(WeeklyFinancial, { foreignKey: 'world_membership_id', as: 'weeklyFinancials' });
WeeklyFinancial.belongsTo(WorldMembership, { foreignKey: 'world_membership_id', as: 'membership' });
...
// Airspace restriction associations
